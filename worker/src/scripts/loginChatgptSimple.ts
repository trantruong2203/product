/**
 * Login script for ChatGPT with persistent session
 * Usage: npx tsx src/scripts/loginChatgptSimple.ts
 *
 * This script:
...
async function login() {
  ...
  console.log("  1. Login to your ChatGPT account in the browser window");
