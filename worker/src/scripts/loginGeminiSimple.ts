/**
 * Login script for Gemini with persistent session
 * Usage: npx tsx src/scripts/loginGeminiSimple.ts
 *
 * This script:
...
async function login() {
  ...
  console.log("✅ Gemini opened successfully!");
  console.log("");
  console.log("📋 Instructions:");
  console.log("  1. Login to your Google account in the browser window");
